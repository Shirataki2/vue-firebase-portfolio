<template>
  <div class="container header-container">
    <div>
      <div class="row">
        <router-link v-for="link in links" :key="link.id" class="col-3 header-text text" :to=link.to>
          <div class="header-link">{{ link.name }}</div>
...
a {
  ...
  .text {
    ...
    display: block;
    transition: transform 0.4s $easeInExpo 0.4s;
  }
